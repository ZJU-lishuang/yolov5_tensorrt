...
class SILU : public IPluginV2DynamicExt
{
public:
    SILU();
    ...
    bool supportsFormatCombination(int32_t pos, const PluginTensorDesc* inOut, int32_t nbInputs, int32_t nbOutputs) TRT_NOEXCEPT override;
    ...
    void configurePlugin(const DynamicPluginTensorDesc* in, int32_t nbInputs,const DynamicPluginTensorDesc* out, int32_t nbOutputs) TRT_NOEXCEPT override;
...
public:
    ...
    IPluginV2DynamicExt* createPlugin(const char* name, const PluginFieldCollection* fc) TRT_NOEXCEPT override;
